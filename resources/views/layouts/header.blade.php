                ...
                <ul class="main-nav">
                    ...
                    <li class="has-submenu">
                        ...
                        <ul class="submenu">
                            ...
                            <li><a href="{{route('register.next')}}">Register</a></li>
                    ...
                    <li>
                        <a href="{{route('admin.next')}}" target="_blank">Admin</a>
                    </li>
                </ul>
            </div>
            <ul class="nav header-navbar-rht reg-head">
                <li><a href="{{route('register.next')}}" class="reg-btn"><img src="assets/img/icon/users.svg"
